...
describe('From input', () => {
    ...
    it('Fill Inline Forms', () => {
        cy.get('input[placeholder="Jane Doe"]').type('Andri Yoga')
        cy.get('[placeholder ="Email"][type="text"]').type('andriyss86@gmail.com')
        cy.get('.custom-checkbox').first().click()
    })
    it('Using Grid', () => {
        cy.get('#inputEmail1').type('andriyss86@gmail.com')
        cy.get('#inputPassword2').type('1234567890')
        cy.get('.text').contains('Option 1').click()
        cy.get('.text').contains('Option 2').click()
    })
    it('Basic Form', () => {
        cy.get('#exampleInputEmail1').type('andriyss86@gmail.com')
        cy.get('#exampleInputPassword1').type('1234567890')
        cy.get('.text').contains('Check me out').click()
    })
    it('Form Without Labels', () => {
        cy.get('[placeholder="Recipients"]').type('andriyss86@gmail.com')
    ...
    it('Block Form', () => {
        cy.get('#inputFirstName').type('Andri')
        cy.get('#inputLastName').type('Yoga')
        cy.get('#inputEmail').type('andriyss86@gmail.com')
        cy.get('#inputWebsite').type('www.youtube.com')
    })
    it('Horizontal Form', () => {
        cy.get('#inputEmail3').type('andriyss86@gmail.com')
